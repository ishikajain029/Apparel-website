...
?>
   ...
   <div id="mobile">
    ...
    <section id="blog">
        <div class="blog-box">
            <div class="blog-img">
                <img src="img1/blog/b1.jpg" alt="">
            </div>
            <div class="blog-details">
                <h4>The Cotton-Jersey Zip-Up Hoodie</h4>
           <p>Kickstart man braid godard coloring book,Reclette waistcoat selfies yr wolf chartreuse hexgon irony,godard</p>
    ...
    <section id="pagination" class="section-p1">
        <a href="#">1</a>
        <a href="#">2</a>
        <a href="#"><i class='fas fa-arrow-right' style='font-size:13px'></i></a>
    </section>
