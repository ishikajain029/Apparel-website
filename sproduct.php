...
?>
  ...
  <img src="bars-solid.svg" id ="bar" alt="bars">
    ...
    <section id="prodetails" clas="section-p1">
        <div class="single-pro-image">
            <img src="img1/products/f1.jpg" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img1/products/f1.jpg" width="100%" class="small-img" alt="">
                    </div>

                
                <div class="small-img-col">
                    <img src="img1/products/f2.jpg" width="100%" class="small-img" alt="">


                </div>
                <div class="small-img-col">
                    <img src="img1/products/f3.jpg" width="100%" class="small-img" alt="">


                </div>
                <div class="small-img-col">
                    <img src="img1/products/f4.jpg" width="100%" class="small-img" alt="">
...
<div class="single-pro-details">
    ...
    <h4 style="color:#184441;">Product Details</h4>
    <spann style="color: rgb(141 171 158);">
        The Gliden Ultra Cotton T-shirts is made from a substantial 6.0 oz.par sq.yd. frabic constructed from 100% cotton, this classic fit preshurnk jersey knit provides unmatched comfort with each wear,Featuring a taped neck and shoulder, and a semless double-needle collar,and available in a range of colors,it offers it all in the ultimate head-turning package. 
    </span>
    ...
    <script>
        ...
        // changing image when we click on that image
